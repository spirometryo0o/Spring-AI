...
import com.example.service.InternetSearchService;

@Component
public class Ex7AccommodationAgent {
  //-----------------------------------------------------------------------------------
  ...
  //-----------------------------------------------------------------------------------
   public Ex7AccommodationAgent(ChatClient.Builder chatClientBuilder, InternetSearchService searchService) {
